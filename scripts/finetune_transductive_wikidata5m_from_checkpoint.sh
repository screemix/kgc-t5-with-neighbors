...
TASK_NAME=not-pretrained-wikidata-from-checkpoint-2
...
horovodrun --gloo -np $NP python run_finetuning_kglm.py \
        ...
        --cpt_path ./runs/t5-small/not-pretrained-wikidata-from-checkpoint/lr1e-05_constant_with_warmup_adamw_wd1e-03_512-512_bs320_iters3000000_pretrained/run_1 \
        --model_cfg $MODEL_CFG \
